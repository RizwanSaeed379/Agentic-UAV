# shared/logger.py — shared structured run logger for all three paradigms.
#
# Appends one JSONL entry per test run to uav_test_results.jsonl at the project
# root, giving cross-paradigm comparison a machine-readable schema instead of
# relying on the per-paradigm narrative .txt logs.
import json
import os
